...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            ...
            <h4 class="header-title m-t-0">Tambah Karyawan</h4>
...
<div class="row">
    <div class="col-12">
        <div class="card-box table-responsive">
            <h4 class="m-t-0 header-title"><b>Penilaian Kinerja Karyawan</b></h4>
            ...
            <table id="table-mahasiswa" class="table table-bordered">
                ...
                <tr>
                    ...
                    <th>NIP</th>
                    <th>Nama Lengkap</th>
                    <th>Grooming</th> <!-- Prestasi -->
                    <th>Self Confidence</th> <!-- Karya Ilmiah -->
                    <th>Attitude</th> <!-- Bahasa Asing-->
                    <th>Jumlah Izin</th> <!-- IPK -->
                    <th>Aksi</th>                                            
                </tr>
                </thead>
